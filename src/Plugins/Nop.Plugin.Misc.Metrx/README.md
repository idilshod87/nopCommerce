...
### Упрощенный Layout для статических страниц

Плагин автоматически переопределяет отображение статических страниц (Topics), таких как "Политика конфиденциальности", "Условия использования" и т.д.:
